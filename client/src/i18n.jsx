...
const dictionaries = {
  zh: {
    ...
    "nav.myTickets": "我的申请",
    "nav.admin": "后台工作台",
    "nav.leaderApproval": "领导审批",
    "nav.typical": "典型问题",

    "role.user": "用户",
    "role.admin": "管理员",
    "role.superAdmin": "超级管理员",
    "role.levelAdmin": "{level}级管理员",
    ...
    "admin.menuPermissions": "权限分配",
    "admin.menuPermissionsDesc": "分配超级/1级/2级管理员",
    ...
    "admin.permissionsTitle": "管理员权限管理",
    "admin.permissionsDesc": "超级管理员可授予超级、1级和2级管理员权限，1级管理员可分配1级或2级管理员；密码重置通过弹框完成。",
    "admin.userPermissions": "用户权限列表",
    "admin.adminLevel": "管理员等级",
  ...
  en: {
    ...
    "nav.leaderApproval": "Leader Approval",
    "nav.typical": "Typical Issues",

    "role.user": "User",
    "role.admin": "Admin",
    "role.superAdmin": "Super Admin",
    "role.levelAdmin": "Level {level} Admin",
    ...
    "admin.menuPermissionsDesc": "Assign admin roles and levels",
    ...
    "admin.permissionsTitle": "Admin Permissions",
    "admin.permissionsDesc": "Super admins can grant all admin levels; level 1 admins can assign level 1 or 2 admins. Password resets are handled in a dialog.",
    "admin.userPermissions": "User Permissions",
    "admin.adminLevel": "Admin Level",
