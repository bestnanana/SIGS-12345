...
const dictionaries = {
  zh: {
    ...
    "home.ticketLoadFailed": "暂时无法加载我发起的事项。",
    ...
    "typical.tag": "典型问题",
    "typical.apiInvalid": "典型问题接口返回异常，请确认后端已重启到最新版本。",
    "typical.loadFailed": "暂时无法获取典型问题，请确认后端服务正在运行。",
    ...
    "admin.configDeptDesc": "用于表单里的部门选择，分为职能处室和教学科研机构。",
  ...
  en: {
    ...
    "typical.apiInvalid": "The typical issues API returned an unexpected response. Please confirm the backend is up to date.",
    "typical.loadFailed": "Unable to load typical issues right now. Please confirm the backend service is running.",
